...
import youtube_dl
from tkinter import Tk, Canvas, Button, Frame, Label, PhotoImage, Toplevel, Entry, Text, END, Scrollbar, filedialog, \
   messagebox
...
class Welcome:
   def __init__(self, parent):
      ...
      self.playlist_button = Button(self.center_frame, text="Download a playlist", command=self.OpenPLDown)
...
class DownVid(Toplevel):
   def __init__(self, parent):
      ...
      self.dir_button = Button(self.center_frame, text="Download to", command=self.getDirectory)
      ...
      self.download_mp4_button = Button(self.center_frame, text="Download as MP4", command=self.downloadMP4)
      self.download_mp4_button.place(rely=.875, relwidth=.25, relheight=.05)
      self.download_mp3_button = Button(self.center_frame, text="Download as MP3", command=self.downloadMP3)
